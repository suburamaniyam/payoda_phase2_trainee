...
namespace MedicineOfDoctorPatients.Controllers
{
    ...
    public class DoctorsController : ControllerBase
    {
        ...
        public DoctorsController(PatientsDbContext context)
        {
            _context = context;
        }
        ...
        {
            return await _context.Doctor.Include(x=>x.Patient).ToListAsync();
        }
        ...
        {
            var doctor = await _context.Doctor.Include(x => x.Patient).FirstOrDefaultAsync(x => x.Docid == id);
        ...
        {
            return _context.Doctor.Any(e => e.Docid == id);
        }
    }
}
